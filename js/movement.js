function handlePlayerMovement(player, keys, depthSortedObjects) {
    ...
    if (wasMoving && !player.isMoving) {
        ...
        switch (player.lastDirection) {
            case 'left':
                player.anims.play("alex_idle_side", true);
                player.flipX = true;
                break;
            case 'right':
                player.anims.play("alex_idle_side", true);
                ...
                break;
            case 'up':
                player.anims.play("alex_idle_back", true);
                break;
            case 'down':
                player.anims.play("alex_idle_front", true);
                break;
        }
    }
